...
use super::routeguide::{Feature, Point, Rectangle, RouteNote, RouteSummary};
use super::routeguide::route_guide_server::RouteGuide;
...
impl RouteGuide for RouteGuideService {
    ...
    // Boilerplate for bidirectional streaming
    // dyn: dynamic type dispatch
    // Box: heap allocation
    // Pin: Never move its memory location (because async code may have self-referential pointers)
    // Send: Thread safe
    // static: make it live for the entire program
